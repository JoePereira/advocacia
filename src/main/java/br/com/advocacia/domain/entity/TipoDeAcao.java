package br.com.advocacia.domain.entity;
...
public class TipoDeAcao {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SQ_TP_DE_ACAO")
    @SequenceGenerator(name = "SQ_TP_DE_ACAO", sequenceName = "SQ_TP_DE_ACAO")
